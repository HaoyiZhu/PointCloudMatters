...
class StationaryManipulationEnv(BaseEnv):
    ...
    def _register_cameras(self):
        ...
        front_pose = pose
        back_pose = look_at([-0.5, 0.2, 0.6], [-0.1, 0, 0.1])
        right_pose = look_at([0, 0.3, 0.6], [-0.1, 0, 0.1])
        left_pose = look_at([0, -0.3, 0.6], [-0.1, 0, 0.1])
        ...
        for angle in angles:
            ...
            left_angle_pose = look_at([left_x, left_y, 0.6], [-0.1, 0, 0.1])
            ...
            right_angle_pose = look_at([down_x, 0, 0.6 + down_z], [-0.1, 0, 0.1])
            additional_cameras.append(
                CameraConfig(
