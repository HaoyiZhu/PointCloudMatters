...
@register_env("Pour-MultiView", max_episode_steps=350)
class PourEnv(MPMBaseEnv):
    ...
    def _register_cameras(self):
        ...
        back_pose = look_at([-0.4, 0.1, 0.3], [-0.1, 0, 0.1])
        right_pose = look_at([0, 0.4, 0.3], [-0.1, 0, 0.1])
        left_pose = look_at([0.1, -0.4, 0.3], [-0.1, 0, 0.1])
        ...
        for angle in angles:
            ...
            left_angle_pose = look_at([left_x, left_y, 0.3], [-0.1, 0, 0.1])
            ...
            right_angle_pose = look_at([down_x, 0, 0.3 + down_z], [-0.1, 0, 0.1])
            additional_cameras.append(
                CameraConfig(
